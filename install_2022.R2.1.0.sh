...
sfdx force:package:installed:list -u $TARGET | fgrep 11.1.0-04t6g000008C4yiAAC-baf6128d || sfdx force:package:install --noprompt -u $TARGET --package 11.1.0-04t6g000008C4yiAAC-baf6128d -w 15
