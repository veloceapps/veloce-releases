...
sfdx force:package:installed:list -u $TARGET | fgrep 11.1.0-baf6128d-04t6g000008C4yiAAC || sfdx force:package:install --noprompt -u $TARGET --package 11.1.0-baf6128d-04t6g000008C4yiAAC -w 15
