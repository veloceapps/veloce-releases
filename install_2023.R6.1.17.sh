...
sfdx force:package:installed:list -u $TARGET | fgrep 16.11.0-94cbff66-04tUc000000AvJZIA0 || sfdx force:package:install --noprompt -u $TARGET --package 16.11.0-94cbff66-04tUc000000AvJZIA0 -w 15
