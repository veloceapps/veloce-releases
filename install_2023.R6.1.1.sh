...
sfdx force:package:installed:list -u $TARGET | fgrep 16.2.0-a9c40a4b-04t6g000008jo9JAAQ || sfdx force:package:install --noprompt -u $TARGET --package 16.2.0-a9c40a4b-04t6g000008jo9JAAQ -w 15
...
sfdx force:package:installed:list -u $TARGET | fgrep 16.2.0-a9c40a4b-04t6g000008jo9OAAQ || sfdx force:package:install --noprompt -u $TARGET --package 16.2.0-a9c40a4b-04t6g000008jo9OAAQ -w 15
sfdx force:package:installed:list -u $TARGET | fgrep 16.1.0-bcfccf88-04t6g000008jo7NAAQ || sfdx force:package:install --noprompt -u $TARGET --package 16.1.0-bcfccf88-04t6g000008jo7NAAQ -w 15
