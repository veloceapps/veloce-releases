...
sfdx force:package:installed:list -u $TARGET | fgrep 16.2.0-bcfccf88-04t6g000008jo7DAAQ || sfdx force:package:install --noprompt -u $TARGET --package 16.2.0-bcfccf88-04t6g000008jo7DAAQ -w 15
