...
sfdx force:package:installed:list -u $TARGET | fgrep 16.1.0-a9c40a4b-04t6g000008jo9TAAQ || sfdx force:package:install --noprompt -u $TARGET --package 16.1.0-a9c40a4b-04t6g000008jo9TAAQ -w 15
