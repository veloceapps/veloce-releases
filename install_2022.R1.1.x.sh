...
sfdx force:package:installed:list -u $TARGET | fgrep 1009.1-04t6g000008C4b8AAC-31c0b070 || sfdx force:package:install --noprompt -u $TARGET --package 1009.1-04t6g000008C4b8AAC-31c0b070 -w 15
