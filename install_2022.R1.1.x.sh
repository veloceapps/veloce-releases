...
sfdx force:package:installed:list -u $TARGET | fgrep 10.9-04t6g000008C4kaAAC-12d4db9 || sfdx force:package:install --noprompt -u $TARGET --package 10.9-04t6g000008C4kaAAC-12d4db9 -w 15
