...
sfdx force:package:installed:list -u $TARGET | fgrep 1009.4-04t6g000008C4f0AAC-12d4db94 || sfdx force:package:install --noprompt -u $TARGET --package 1009.4-04t6g000008C4f0AAC-12d4db94 -w 15
