...
sfdx force:package:installed:list -u $TARGET | fgrep 15.3.0-dd92e183-04t6g000008KR2HAAW || sfdx force:package:install --noprompt -u $TARGET --package 15.3.0-dd92e183-04t6g000008KR2HAAW -w 15
