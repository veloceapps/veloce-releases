...
sfdx force:package:installed:list -u $TARGET | fgrep 19.1.0-418477d9-04tUc000000JXmfIAG || sfdx force:package:install --noprompt -u $TARGET --package 19.1.0-418477d9-04tUc000000JXmfIAG -w 15
