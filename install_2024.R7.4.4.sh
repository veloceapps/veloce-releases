...
sfdx force:package:installed:list -u $TARGET | fgrep 19.1.0-b921bd3e-04tUc000000JRULIA4 || sfdx force:package:install --noprompt -u $TARGET --package 19.1.0-b921bd3e-04tUc000000JRULIA4 -w 15
