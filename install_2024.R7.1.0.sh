...
sfdx force:package:installed:list -u $TARGET | fgrep 17.0.0-e8b36c00-04tUc000000BKQ1IAO || sfdx force:package:install --noprompt -u $TARGET --package 17.0.0-e8b36c00-04tUc000000BKQ1IAO -w 15
