...
sfdx force:package:installed:list -u $TARGET | fgrep 14.0.0-7-ae865a03-04t6g000008OYALAA4 || sfdx force:package:install --noprompt -u $TARGET --package 14.0.0-7-ae865a03-04t6g000008OYALAA4 -w 15
