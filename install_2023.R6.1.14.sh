...
sfdx force:package:installed:list -u $TARGET | fgrep 16.9.0-fab73b5c-04tUc0000007zTNIAY || sfdx force:package:install --noprompt -u $TARGET --package 16.9.0-fab73b5c-04tUc0000007zTNIAY -w 15
