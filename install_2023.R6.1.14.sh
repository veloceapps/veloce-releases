...
sfdx force:package:installed:list -u $TARGET | fgrep 16.9.0-9a177620-04tUc0000007zWbIAI || sfdx force:package:install --noprompt -u $TARGET --package 16.9.0-9a177620-04tUc0000007zWbIAI -w 15
