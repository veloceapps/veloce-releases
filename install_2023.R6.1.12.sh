...
sfdx force:package:installed:list -u $TARGET | fgrep 16.7.0-7c16ad18-04tUc00000070CzIAI || sfdx force:package:install --noprompt -u $TARGET --package 16.7.0-7c16ad18-04tUc00000070CzIAI -w 15
