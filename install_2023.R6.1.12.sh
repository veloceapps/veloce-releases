...
sfdx force:package:installed:list -u $TARGET | fgrep 16.7.0-6dd17261-04tUc0000006wu9IAA || sfdx force:package:install --noprompt -u $TARGET --package 16.7.0-6dd17261-04tUc0000006wu9IAA -w 15
