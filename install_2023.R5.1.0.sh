...
sfdx force:package:installed:list -u $TARGET | fgrep 15.1.0-b07e55e0-04t6g000008SnOvAAK || sfdx force:package:install --noprompt -u $TARGET --package 15.1.0-b07e55e0-04t6g000008SnOvAAK -w 15
