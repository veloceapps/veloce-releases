...
sfdx force:package:installed:list -u $TARGET | fgrep 15.0.0-8434a8c9-04t6g000008SnKZAA0 || sfdx force:package:install --noprompt -u $TARGET --package 15.0.0-8434a8c9-04t6g000008SnKZAA0 -w 15
