...
sfdx force:package:installed:list -u $TARGET | fgrep 16.4.0-d1d5d3e2-04t6g000008joY3AAI || sfdx force:package:install --noprompt -u $TARGET --package 16.4.0-d1d5d3e2-04t6g000008joY3AAI -w 15
