...
sfdx force:package:installed:list -u $TARGET | fgrep 16.4.0-d1d5d3e2-04t6g000008joYhAAI || sfdx force:package:install --noprompt -u $TARGET --package 16.4.0-d1d5d3e2-04t6g000008joYhAAI -w 15
...
sfdx force:package:installed:list -u $TARGET | fgrep 16.4.0-d1d5d3e2-04t6g000008joYmAAI || sfdx force:package:install --noprompt -u $TARGET --package 16.4.0-d1d5d3e2-04t6g000008joYmAAI -w 15
sfdx force:package:installed:list -u $TARGET | fgrep 16.3.0-d1d5d3e2-04t6g000008joYrAAI || sfdx force:package:install --noprompt -u $TARGET --package 16.3.0-d1d5d3e2-04t6g000008joYrAAI -w 15
