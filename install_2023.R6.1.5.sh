...
sfdx force:package:installed:list -u $TARGET | fgrep 16.4.0-de3611a5-04t6g000008joTWAAY || sfdx force:package:install --noprompt -u $TARGET --package 16.4.0-de3611a5-04t6g000008joTWAAY -w 15
