...
sfdx force:package:installed:list -u $TARGET | fgrep 14.5.0-f3020c2f-04t6g000008nziIAAQ || sfdx force:package:install --noprompt -u $TARGET --package 14.5.0-f3020c2f-04t6g000008nziIAAQ -w 15
