...
sfdx force:package:installed:list -u $TARGET | fgrep 14.6.0-f3020c2f-04t6g000008nziDAAQ || sfdx force:package:install --noprompt -u $TARGET --package 14.6.0-f3020c2f-04t6g000008nziDAAQ -w 15
