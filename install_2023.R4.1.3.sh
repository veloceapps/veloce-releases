...
sfdx force:package:installed:list -u $TARGET | fgrep 14.3.0-5e6af9d8-04t6g000008nzWkAAI || sfdx force:package:install --noprompt -u $TARGET --package 14.3.0-5e6af9d8-04t6g000008nzWkAAI -w 15
