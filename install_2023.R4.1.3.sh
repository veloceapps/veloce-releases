...
sfdx force:package:installed:list -u $TARGET | fgrep 14.3.0-8a4a8adb-04t6g000008OYNaAAO || sfdx force:package:install --noprompt -u $TARGET --package 14.3.0-8a4a8adb-04t6g000008OYNaAAO -w 15
