...
sfdx force:package:installed:list -u $TARGET | fgrep 16.9.0-6d5de63d-04tUc0000008jBFIAY || sfdx force:package:install --noprompt -u $TARGET --package 16.9.0-6d5de63d-04tUc0000008jBFIAY -w 15
