...
sfdx force:package:installed:list -u $TARGET | fgrep 16.11.0-53139716-04tUc000000AvHxIAK || sfdx force:package:install --noprompt -u $TARGET --package 16.11.0-53139716-04tUc000000AvHxIAK -w 15
