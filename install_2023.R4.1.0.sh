...
sfdx force:package:installed:list -u $TARGET | fgrep 15.0.0-ddfce2da-04t6g000008OYEXAA4 || sfdx force:package:install --noprompt -u $TARGET --package 15.0.0-ddfce2da-04t6g000008OYEXAA4 -w 15
