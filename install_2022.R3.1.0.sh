...
sfdx force:package:installed:list -u $TARGET | fgrep 12.3.0-4fdb8436-04t6g000008OXuWAAW || sfdx force:package:install --noprompt -u $TARGET --package 12.3.0-4fdb8436-04t6g000008OXuWAAW -w 15
