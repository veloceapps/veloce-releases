...
sfdx force:package:installed:list -u $TARGET | fgrep 18.1.0-d4ecec34-04tUc000000FGcLIAW || sfdx force:package:install --noprompt -u $TARGET --package 18.1.0-d4ecec34-04tUc000000FGcLIAW -w 15
...
sfdx force:package:installed:list -u $TARGET | fgrep 18.1.0-d4ecec34-04tUc000000FGdxIAG || sfdx force:package:install --noprompt -u $TARGET --package 18.1.0-d4ecec34-04tUc000000FGdxIAG -w 15
sfdx force:package:installed:list -u $TARGET | fgrep 18.1.0-d4ecec34-04tUc000000FGfZIAW || sfdx force:package:install --noprompt -u $TARGET --package 18.1.0-d4ecec34-04tUc000000FGfZIAW -w 15
