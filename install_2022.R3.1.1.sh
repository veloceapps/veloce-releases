...
sfdx force:package:installed:list -u $TARGET | fgrep 12.7.0-e0099988-04t6g000008OXyJAAW || sfdx force:package:install --noprompt -u $TARGET --package 12.7.0-e0099988-04t6g000008OXyJAAW -w 15
