...
sfdx force:package:installed:list -u $TARGET | fgrep 16.7.0-8447c580-04tUc0000007d4fIAA || sfdx force:package:install --noprompt -u $TARGET --package 16.7.0-8447c580-04tUc0000007d4fIAA -w 15
