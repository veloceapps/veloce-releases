...
sfdx force:package:installed:list -u $TARGET | fgrep 16.6.0-8447c580-04tUc0000007d7tIAA || sfdx force:package:install --noprompt -u $TARGET --package 16.6.0-8447c580-04tUc0000007d7tIAA -w 15
