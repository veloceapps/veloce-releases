...
sfdx force:package:installed:list -u $TARGET | fgrep 16.7.0-8447c580-04tUc0000007d6HIAQ || sfdx force:package:install --noprompt -u $TARGET --package 16.7.0-8447c580-04tUc0000007d6HIAQ -w 15
