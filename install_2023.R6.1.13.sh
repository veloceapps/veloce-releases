...
sfdx force:package:installed:list -u $TARGET | fgrep 16.8.0-0f6ac08a-04tUc0000007jbVIAQ || sfdx force:package:install --noprompt -u $TARGET --package 16.8.0-0f6ac08a-04tUc0000007jbVIAQ -w 15
