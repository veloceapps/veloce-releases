...
sfdx force:package:installed:list -u $TARGET | fgrep 20.2.0-e355568b-04tUc000000ZXsLIAW || sfdx force:package:install --noprompt -u $TARGET --package 20.2.0-e355568b-04tUc000000ZXsLIAW -w 15
...
sfdx force:package:installed:list -u $TARGET | fgrep 20.2.0-3479f55a-04tUc000000ZXkHIAW || sfdx force:package:install --noprompt -u $TARGET --package 20.2.0-3479f55a-04tUc000000ZXkHIAW -w 15
sfdx force:package:installed:list -u $TARGET | fgrep 20.2.0-3479f55a-04tUc000000ZXnVIAW || sfdx force:package:install --noprompt -u $TARGET --package 20.2.0-3479f55a-04tUc000000ZXnVIAW -w 15
