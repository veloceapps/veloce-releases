...
sfdx force:package:installed:list -u $TARGET | fgrep 20.2.0-3479f55a-04tUc000000ZXh3IAG || sfdx force:package:install --noprompt -u $TARGET --package 20.2.0-3479f55a-04tUc000000ZXh3IAG -w 15
...
sfdx force:package:installed:list -u $TARGET | fgrep 20.2.0-893513fd-04tUc000000ZXVlIAO || sfdx force:package:install --noprompt -u $TARGET --package 20.2.0-893513fd-04tUc000000ZXVlIAO -w 15
