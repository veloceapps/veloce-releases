...
sfdx force:package:installed:list -u $TARGET | fgrep 20.2.0-8aa8251b-04tUc000000ZXcDIAW || sfdx force:package:install --noprompt -u $TARGET --package 20.2.0-8aa8251b-04tUc000000ZXcDIAW -w 15
