...
sfdx force:package:installed:list -u $TARGET | fgrep 20.2.0-613b89d5-04tUc000000ZY3dIAG || sfdx force:package:install --noprompt -u $TARGET --package 20.2.0-613b89d5-04tUc000000ZY3dIAG -w 15
