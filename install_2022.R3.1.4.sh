...
sfdx force:package:installed:list -u $TARGET | fgrep 13.4.0-2c448f2d-04t6g000008OYFzAAO || sfdx force:package:install --noprompt -u $TARGET --package 13.4.0-2c448f2d-04t6g000008OYFzAAO -w 15
