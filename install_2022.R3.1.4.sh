...
sfdx force:package:installed:list -u $TARGET | fgrep 13.8.0-f1c503f9-04t6g000008OYIUAA4 || sfdx force:package:install --noprompt -u $TARGET --package 13.8.0-f1c503f9-04t6g000008OYIUAA4 -w 15
