...
sfdx force:package:installed:list -u $TARGET | fgrep 13.9.0-4556128c-04t6g000008OYNQAA4 || sfdx force:package:install --noprompt -u $TARGET --package 13.9.0-4556128c-04t6g000008OYNQAA4 -w 15
