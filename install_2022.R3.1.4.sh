...
sfdx force:package:installed:list -u $TARGET | fgrep 13.5.0-b84a6c0f-04t6g000008OYE3AAO || sfdx force:package:install --noprompt -u $TARGET --package 13.5.0-b84a6c0f-04t6g000008OYE3AAO -w 15
