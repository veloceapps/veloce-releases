...
sfdx force:package:installed:list -u $TARGET | fgrep 13.4.0-d79a17a2-04t6g000008OYClAAO || sfdx force:package:install --noprompt -u $TARGET --package 13.4.0-d79a17a2-04t6g000008OYClAAO -w 15
