...
sfdx force:package:installed:list -u $TARGET | fgrep 14.8.0-d91b3f31-04t6g000008SnMpAAK || sfdx force:package:install --noprompt -u $TARGET --package 14.8.0-d91b3f31-04t6g000008SnMpAAK -w 15
