...
sfdx force:package:installed:list -u $TARGET | fgrep 14.7.0-d91b3f31-04t6g000008SnMzAAK || sfdx force:package:install --noprompt -u $TARGET --package 14.7.0-d91b3f31-04t6g000008SnMzAAK -w 15
