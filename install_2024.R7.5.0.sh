...
sfdx force:package:installed:list -u $TARGET | fgrep 20.0.0-2c539d3d-04tUc000000NLDRIA4 || sfdx force:package:install --noprompt -u $TARGET --package 20.0.0-2c539d3d-04tUc000000NLDRIA4 -w 15
